package com.megabares.online.views.resumen;


import com.megabares.online.views.resumen.ServiceHealth.Status;
...
@RolesAllowed("USER")
public class ResumenView extends Main {

    public ResumenView() {
        addClassName("resumen-view");
